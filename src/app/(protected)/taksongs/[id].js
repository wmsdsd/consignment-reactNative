                ...
                <View className="flex-1">
                    ...
                    <View className="w-full flex-1 items-center justify-center rounded-2xl bg-neutral-900 p-6">
                        ...
                        <Text className="text-center text-4xl font-bold text-white">
                            {taksong.carNumber || '미배정'}
                        </Text>
                        
                        {/* 거리 및 시간 */}
                        <View className="mt-5 flex-row justify-center gap-4">
                            <Text className="text-xl text-gray-300">{mToKm(taksong.distance)}</Text>
                            <Text className="text-lg text-gray-600">|</Text>
                            <Text className="text-xl text-gray-300">{secondToTimeHangul(taksong.time)}</Text>
                        </View>
                    ...
                    <View
                        ...
                        <Text className="text-2xl font-semibold text-white">{addCommaToNumber(taksong.price)}</Text>
                    </View>
                </View>
            </View>
